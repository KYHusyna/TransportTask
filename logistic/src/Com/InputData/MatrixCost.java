...
public class MatrixCost {
    ...
    private void createCostMatrix() {
         matrixCost = new int[storage.length][order.length];
    ...
    protected void setMatrixCost(int[][] newDeliveryMatrix){
        matrixCost = new int[newDeliveryMatrix.length][newDeliveryMatrix[0].length];
